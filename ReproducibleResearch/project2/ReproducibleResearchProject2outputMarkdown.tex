...
\KeywordTok{download.file}\NormalTok{(fileUrl, }\DataTypeTok{destfile =} \KeywordTok{paste0}\NormalTok{(}\KeywordTok{getwd}\NormalTok{(), }\StringTok{'/repdata%2Fdata%2FStormData.csv.bz2'}\NormalTok{))}
\NormalTok{stormDF <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\KeywordTok{getwd}\NormalTok{(), }\StringTok{'/repdata%2Fdata%2FStormData.csv.bz2'}\NormalTok{))}
...
\includegraphics{ReproducibleResearchProject2outputMarkdown_files/figure-latex/healthChart-1.pdf}
...
\includegraphics{ReproducibleResearchProject2outputMarkdown_files/figure-latex/econChart-1.pdf}
